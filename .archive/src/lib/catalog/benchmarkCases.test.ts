...
// Split out of caseCatalog.test.ts (frontend execution plan Wave 3 W3.2):
// this content tests benchmarkCases.ts's own legacy benchmark-family
// runtime data/logic, not caseCatalog.ts's Custom Mode facet system —
// caseCatalog.ts no longer re-exports these names.
describe('benchmarkCases legacy benchmark-family registry', () => {
