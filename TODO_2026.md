...
- [ ] `P4-1` Benchmark simulator results against published two-phase reference cases and document acceptance tolerances in README.md and in a separate page accessible via link or better popup if results are concise.
...
- [ ] `NTH-1` Implement gravity terms in pressure/flux equations (with toggle + validation cases).
- [ ] `NTH-2` Extend to 3-phase flow (oil/water/gas) and optional aquifer coupling model.