...
| `docs/FIM_OPM_CONVERGENCE_EXECUTION_PLAN.md` | Active decision-frontier plan: source audit, bound/update characterization, guarded probe, promotion matrix, and simple-model handoff gates |
