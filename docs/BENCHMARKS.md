...
|---|---|---|---|---|---|
| 1D waterflood breakthrough | Buckley-Leverett + Welge | BL-Case-A nx=24: breakthrough_rel_err 9.44 % | 25.0 % | 38% | `d22d498` |
| SPE1 Case 1, 10 years | Published SPE1 / Flow | 10x10x3: pressure_rel_err 1.34 % | 3.0 % | 45% | `d22d498` |
| Three-phase gas drive and injection | OPM Flow | gas_drive: oil_rate_rel_err 3.90 % | 8.0 % | 49% | `d22d498` |
| Black-oil depletion column | Grid self-convergence, Flow | IMPES: sat_gas_finest_pair_gap 1.21 % | 1.5 % | 80% | `d22d498` |
| Eight small decks, three solvers | OPM Flow, generated decks | no banded criterion | — | — | `d22d498` |
| Native vs wasm bindings | Each other | favorable-mobility (IMPES): rates_max_abs_diff 1.25e-10 abs | 1e-09 abs | 12% | `d22d498` |
| FIM convergence, long horizons | Substeps per report step | no banded criterion | — | — | `d22d498` |
| Compositional, matched timestep | OPM flowexp_comp | 1D plain: worst_pressure_diff 1.68 bar | 2 bar | 84% | `d22d498` |
| Second simulator on the same decks | JutulDarcy vs Flow and FIM | no banded criterion | — | — | `d22d498` |
<!-- /GENERATED:summary -->
...
|---|---|---|---|---|---|
| spe1 | 10x10x3 | vs_flow.FOPR_rel_err | -1.17 % | t=990 d | tracked: #57 |
| spe1 | 10x10x3 | vs_flow.FPR_rel_err | -1.37 % | t=810 d | tracked: #57 |
| spe1 | 10x10x3 | vs_flow.WGOR_rel_err | +1.34 % | t=1620 d | tracked: #57 |
| spe1 | 20x20x3 | vs_flow.FPR_rel_err | -1.34 % | t=720 d | tracked: #57 |
| spe1 | 20x20x3 | vs_flow.WGOR_rel_err | +1.55 % | t=1800 d | tracked: #57 |
...
| spe1 | 5 of 6 | — | 10x10x3: plateau_rel_err | < 0.1 % | — |
...
<!-- GENERATED:buckley -->
*Measured on `d22d498` (clean tree), 2026-09-25.*
...
<!-- GENERATED:spe1 -->
*Measured on `d22d498` (clean tree), 2026-09-25, flow `flow 2026.04`.*

Against the published series:

| Criterion | Band | Worst measured |
|---|---|---|
| Field average pressure, yearly to 3650 d | 3.0 % | 1.345 % (t=730 d) |
| Producer oil rate, yearly to 3650 d | 8.0 % | 1.268 % (t=1095 d) |
| Producing GOR, yearly to 3650 d | 12.0 % | 1.854 % (t=730 d) |
| Oil-rate plateau while the reference is on plateau (≤ 730 d) | 0.5 % | 2.6e-07 % (t=730 d) |
| Oil material-balance drift | 1.0 % | 3.9e-05 % (t=2190 d) |
| Gas material-balance drift | 1.0 % | 1.6e-04 % (t=3650 d) |

Characterization against the published 10×10×3 series (no band):

| Grid | p | q_o | GOR |
|---|---|---|---|
| 10x10x3 | 1.33 % | 1.29 % | 1.68 % |
| 20x20x3 | 2.17 % | 7.74 % | 22.71 % |
...
| Grid | p | q_o | GOR |
|---|---|---|---|
| 10x10x3 | -1.37 % | -1.17 % | +1.34 % |
| 20x20x3 | -1.34 % | -0.87 % | +1.55 % |
<!-- /GENERATED:spe1 -->
...
|  | ResSim FIM sparse | 301 | 908 | 0 | 475 | 0.307 | 2.4e-07 | 0.00023 | FOPT 2.3e-08 %, FGPT 1.06 % |
|  | ResSim FIM dense | 301 | 908 | 0 | 666 | 0.307 | 2.4e-07 | 0.00023 | FOPT 2.3e-08 %, FGPT 1.06 % |
|  | ResSim IMPES | 300 | — | — | 231 | 0.322 | 1.8e-07 | 0.00026 | FOPT 0.00 %, FGPT 2.10 % |
| dep-pvt-lab-report | Flow | 300 | 607 | 0 |  |  |  |  |  |
|  | ResSim FIM sparse | 301 | 906 | 0 | 483 | 0.221 | 2.1e-07 | 0.00025 | FOPT 5.0e-08 %, FGPT 1.13 % |
|  | ResSim FIM dense | 301 | 906 | 0 | 669 | 0.221 | 2.1e-07 | 0.00025 | FOPT 5.0e-08 %, FGPT 1.13 % |
|  | ResSim IMPES | 300 | — | — | 224 | 0.149 | 1.9e-07 | 0.00028 | FOPT 0.00 %, FGPT 1.59 % |
...
|  | ResSim IMPES | 125 | — | — | 134 | 2.13 | 1.7e-06 | 0.0021 | FOPT 2.87 %, FGPT 0.56 % |
...
|  | ResSim FIM sparse | 120 | 376 | 0 | 164 | 0.943 | 0.032 | 0 | FOPT 0.05 %, FWPT 0.10 %, FWIT 0.07 % |
|  | ResSim FIM dense | 120 | 376 | 0 | 898 | 0.943 | 0.032 | 0 | FOPT 0.05 %, FWPT 0.10 %, FWIT 0.07 % |
|  | ResSim IMPES | 631 | — | — | 116 | 7.51 | 0.19 | 0 | FOPT 0.64 %, FWPT 4.84 %, FWIT 2.82 % |
| ow-2d-12x12 | Flow | 40 | 114 | 0 |  |  |  |  |  |
|  | ResSim FIM sparse | 40 | 133 | 0 | 175 | 0.752 | 0.0079 | 0 | FOPT 0.08 %, FWPT 0.81 %, FWIT 0.21 % |
|  | ResSim FIM dense | 40 | 133 | 0 | 1088 | 0.752 | 0.0079 | 0 | FOPT 0.08 %, FWPT 0.81 %, FWIT 0.21 % |
|  | ResSim IMPES | 225 | — | — | 128 | 23.9 | 0.15 | 0 | FOPT 2.25 %, FWPT 6.16 %, FWIT 3.18 % |
| spe1-10x10x3 | Flow | 124 | 307 | 0 |  |  |  |  |  |
|  | ResSim FIM sparse | 124 | 480 | 0 | 3276 | 1.04 | 1.1e-05 | 0.0072 | FOPT 0.05 %, FGPT 0.07 %, FGIT 1.4e-06 % |
|  | ResSim FIM dense | 124 | 480 | 0 | 3252 | 1.04 | 1.1e-05 | 0.0072 | FOPT 0.05 %, FGPT 0.07 %, FGIT 1.4e-06 % |
|  | ResSim IMPES | 204 | — | — | 6205 | 23.4 | 0.00025 | 0.11 | FOPT 0.06 %, FGPT 0.23 %, FGIT 0.26 % |
<!-- /GENERATED:cross_solver -->
...
<!-- GENERATED:fim_wasm -->
*Measured on `d22d498` (clean tree), 2026-09-25, node `v24.18.0`.*

| Case | Report steps | Substeps | Ratio | Newton | Retries lin/nonlin/mixed | Newton in retries | FIM ms | Linear + precond. |
|---|---|---|---|---|---|---|---|---|
| water-pressure 20x20x3 dt 0.25 | 20 | 20 | 1.00 | 117 | 0/0/0 | 0 | 2726 | 52% |
| water-pressure 22x22x1 dt 0.25 | 20 | 22 | 1.10 | 126 | 0/1/0 | 20 | 1007 | 49% |
| water-pressure 23x23x1 dt 0.25 | 20 | 22 | 1.10 | 123 | 0/1/0 | 20 | 1089 | 50% |
| water-pressure 12x12x3 dt 1 (heavy) | 20 | 23 | 1.15 | 116 | 0/0/0 | 0 | 879 | 44% |
| gas-rate 10x10x3 dt 0.25 | 24 | 27 | 1.12 | 130 | 0/1/0 | 20 | 1302 | 21% |
| gas-pressure 10x10x3 dt 0.25 | 20 | 25 | 1.25 | 147 | 0/2/0 | 40 | 1650 | 24% |
| sweep-areal 21x21x1 dt 0.25 | 20 | 20 | 1.00 | 63 | 0/0/0 | 0 | 341 | 49% |
<!-- /GENERATED:fim_wasm -->
...
<!-- GENERATED:jutul -->
*Measured on `d22d498` (clean tree), 2026-09-25, flow `flow 2026.04`, jutuldarcy `0.3.7`, julia `julia version 1.12.7`.*
...
| spe1-10x10x3 | STONE2, DRSDT | 126 | 0.35 | FGIR +0.00 %, FGPR +5.99 % | 126 | FGIR +0.00 %, FGPR -5.79 % |
<!-- /GENERATED:jutul -->
