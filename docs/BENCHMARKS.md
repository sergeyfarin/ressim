...
<!-- GENERATED:jutul -->
*Measured on `4f2b771` (clean tree), 2026-09-25, flow `flow 2026.04`, jutuldarcy `0.3.7`, julia `julia version 1.12.7`.*
...
| spe1-case2-10x10x3 | STONE2 | 5.25 | 0.031 | FGIR +0.00 %, FGPR -0.19 % | 111 | FGIR +0.00 %, FGPR -2.55 % |
<!-- /GENERATED:jutul -->
