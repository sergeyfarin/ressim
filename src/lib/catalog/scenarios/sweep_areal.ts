            ...
            variants: [
                {
                    ...
                    description: 'Coarse grid — lower numerical accuracy.',
                    paramPatch: { nx: 10, ny: 10, 
        producerI: 9,
        producerJ: 9, cellDx: 20*21/10, cellDy: 20*21/10 },
                    affectsAnalytical: false,
                },
                {
                    key: 'grid_base',
                    label: 'Base Resolution',
                    description: 'Standard grid — balanced accuracy and performance.',
                    paramPatch: { nx: 21, ny: 21, 
        producerI: 20,
        producerJ: 20, cellDx: 20*21/21, cellDy: 20*21/21 },
                ...
                },
                {
                    ...
                    description: 'Fine grid — higher numerical accuracy.',
                    paramPatch: { nx: 48, ny: 48 ,
        producerI: 47,
        producerJ: 47, cellDx: 20*21/48, cellDy: 20*21/48 },
                    affectsAnalytical: false,
                },
            ],
        },
