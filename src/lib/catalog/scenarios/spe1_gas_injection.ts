...
// ── OPM Flow SPE1 Case 1 reference (canonical deck, monthly summary) ──────
// Source: OPM/opm-common/tests/SPE1CASE1.DATA run with `flow 2026.04`
//   (WELLDIMS item 1/2/4 raised to 4 so the RFT observation wells load; no
//   other deck change). Command:
//     flow SPE1CASE1.DATA --output-dir=.
// Conversions: FOPR_sm3d = FOPR_stbd x 0.158987, WBHP_bar = WBHP_psia / 14.5038
// Replaces the earlier "Brontosaurus" 4-point samples, which were inconsistent
// with SPE1 Case 1: they showed oil rate ~flat to 1826 d (3155.9 Sm3/d) where
// the deck's producer hits its 1000 psia BHP floor at ~1000 d and declines to
// 1758.5 Sm3/d at 1826 d and 883.7 Sm3/d at 3650 d.
const SPE1_REF_OIL_RATE: PublishedReferenceSeries = {
    panelKey: 'oil_rate',
    label: 'SPE1 Case 1 Reference — Oil Rate',
...
const SPE1_REF_PRODUCER_WBHP: PublishedReferenceSeries = {
    panelKey: 'producer_bhp',
    label: 'SPE1 Case 1 Reference — PROD WBHP',
...
const SPE1_REF_INJECTOR_WBHP: PublishedReferenceSeries = {
    panelKey: 'injector_bhp',
    label: 'SPE1 Case 1 Reference — INJ WBHP',
