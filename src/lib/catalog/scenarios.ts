...
export const SCENARIOS: Scenario[] = [
        ...
        sensitivities: [
            {
                ...
                description: 'Compare uniform, moderate, and extreme permeability contrasts across layers. The Dykstra-Parsons analytical model uses the actual layer perms, so only the simulation curve changes here.',
                variants: [
                    {
                        key: 'vdp_uniform',
...

    {
        ...
        description: 'Volumetric sweep E_vol = E_A × E_V. Multiply areal (pattern + mobility) by vertical (layered heterogeneity) to see the total fraction of reservoir contacted. — Craig (1971), Dykstra & Parsons (1950)',
        scenarioClass: 'waterflood',
        domain: 'sweep',
        chartPreset: 'waterflood',
        defaultSensitivityDimensionKey: 'combined',
        params: {
            analyticalSolutionMode: 'waterflood',
            // Fluid
            mu_w: 0.5,
        ...
        sensitivities: [
            {
                ...
                description: 'Combine unfavourable mobility (lowers E_A) with layer heterogeneity (lowers E_V) to see the full volumetric sweep penalty. Both simulation and analytical update.',
                variants: [
                    {
                        key: 'comb_ideal',
                        label: 'Ideal  (M ≈ 1, uniform)',
                        description: 'Favourable mobility + uniform permeability — best possible volumetric sweep.',
                        paramPatch: {
                            mu_o: 0.5,
                            permMode: 'uniform',
                            uniformPermX: 100,
                    ...
                    },
                    {
                        ...
                        description: 'Typical field conditions — moderate mobility and heterogeneity. Base case.',
                        paramPatch: {},
                        affectsAnalytical: true,
                    },
                    {
