        ...
        cases: [
            {
                ...
                params: {
                    ...
                    s_wc: 0.1, s_or: 0.1, n_w: 2.0, n_o: 2.0, k_rw_max: 1.0, k_ro_max: 1.0,
        ...
        cases: [
            ...
            },
            {
                ...
                params: {
                    ...
                    mu_w: 0.6, mu_o: 1.4,
                    s_wc: 0.15, s_or: 0.15, n_w: 2.2, n_o: 2.0, k_rw_max: 1.0, k_ro_max: 1.0,
                    gravityEnabled: false,
                    capillaryEnabled: false, capillaryPEntry: 0.0, capillaryLambda: 2.0,
                    permMode: 'uniform',
                    uniformPermX: 2000, uniformPermY: 2000, uniformPermZ: 2000,
            ...
            },
            {
                ...
                params: {
                    ...
                    initialPressure: 300, initialSaturation: 0.2,
                    mu_w: 0.8, mu_o: 1.0,
                    s_wc: 0.1, s_or: 0.1, n_w: 2.1, n_o: 1.9, k_rw_max: 1.0, k_ro_max: 1.0,
                    gravityEnabled: false,
                    capillaryEnabled: false, capillaryPEntry: 0.0, capillaryLambda: 2.0,
                    permMode: 'uniform',
                    uniformPermX: 150, uniformPermY: 150, uniformPermZ: 150,
        ...
        cases: [
            ...
            },
            {
                ...
                params: {
                    ...
                    s_wc: 0.12, s_or: 0.12, n_w: 2.2, n_o: 2.2, k_rw_max: 1.0, k_ro_max: 1.0,
            ...
            },
            {
                ...
                params: {
                    ...
                    s_wc: 0.08, s_or: 0.15, n_w: 1.6, n_o: 2.4, k_rw_max: 1.0, k_ro_max: 1.0,
