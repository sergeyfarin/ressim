...
export const reservoirsimulator_setPermeabilityRandom: (a: number, b: number, c: number) => void;
export const reservoirsimulator_setRelPermProps: (a: number, b: number, c: number, d: number, e: number) => void;
export const reservoirsimulator_setStabilityParams: (a: number, b: number) => void;
