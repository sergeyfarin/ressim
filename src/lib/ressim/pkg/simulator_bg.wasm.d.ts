...
export const reservoirsimulator_getPermX: (a: number) => [number, number];
export const reservoirsimulator_getPermY: (a: number) => [number, number];
export const reservoirsimulator_getPermZ: (a: number) => [number, number];
export const reservoirsimulator_getPorosity: (a: number) => [number, number];
