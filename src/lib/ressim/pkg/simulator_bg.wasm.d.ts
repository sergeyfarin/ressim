...
export const reservoirsimulator_getFimStepStatsHistory: (a: number) => any;
...
export const reservoirsimulator_setFimCoreyTablePoints: (a: number, b: number) => void;
export const reservoirsimulator_setFimEnabled: (a: number, b: number) => void;
export const reservoirsimulator_setFimNestedWellSolve: (a: number, b: number) => void;
export const reservoirsimulator_setFimOpmAlignedNonlinear: (a: number, b: number) => void;
export const reservoirsimulator_setFimTrueFgmres: (a: number, b: number) => void;
...
export const reservoirsimulator_setSweepConfig: (a: number, b: any) => [number, number];
