#!/bin/bash
cat << 'PATCH' > newton.patch
--- src/lib/ressim/src/fim/newton.rs
+++ src/lib/ressim/src/fim/newton.rs
@@ -49,12 +49,54 @@ pub(crate) struct FimStepReport {
...
@@ -85,7 +127,7 @@ pub(crate) fn run_fim_timestep(
                 include_wells: true,
             },
         );
...
@@ -110,7 +152,7 @@ pub(crate) fn run_fim_timestep(
...
@@ -163,7 +205,7 @@ pub(crate) fn run_fim_timestep(
             include_wells: true,
         },
     );
